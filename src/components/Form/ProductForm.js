  ...
  return (
    <Container>
      ...
      <Row>
        ...
        <Col className={classes.root}>
          <DataPicker
            selectedDate={dataFabricacao}
            setSelectedDate={setDataFabricacao}
            label="Data de Fabricação (dd/mm/yyyy)"
          />
        </Col>
      </Row>
      <Row>
        ...
        <Col className={classes.root}>
          {perecivel === "true" && (
            <DataPicker
              ...
              setSelectedDate={setDataValidade}
